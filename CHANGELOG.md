...
## [0.2.9](https://github.com/leandrocp/mdex_native/compare/v0.2.8...v0.2.9) (2026-08-30)

### Features

- Highlight with the Lumis WASM runtime instead of embedded grammars by @leandrocp in [#58](https://github.com/leandrocp/mdex_native/pull/58)
